        ...
        var tableIns = table.render({
            ...
            cols: [
                [
                    ...
                    { field: 'agentName', title: '用户名', width: 180, align: "center" },
                    { field: 'agentNickName', title: '昵称', width: 180, align: "center" },
                    { field: 'agentSup', title: '上级', width: 125, align: "center" },
                    ...
                    { field: 'agentRebate', title: '返点明细', width: 125, align: 'center' },
                    { field: 'agentAccount', title: '账号', width: 125, align: 'center', templet: "#agentAccount" },
                    { field: 'agentBet', title: '投注', width: 125, align: 'center', templet: "#agentBet" },
