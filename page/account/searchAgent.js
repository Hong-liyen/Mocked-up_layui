layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        elem: '#searchAgent',
        url : '../../json/accountSearchAgent.json',
        cellMinWidth : 95,
        page : true,
        height : "full-125",
        limit : 20,
        ...
        cols : [[
            ...
            // }},
            {field: 'agentTime', title: '注册时间', align:'center',sort:"true", minWidth:130, templet:function(d){
    ...
    //上級查看
    table.on('tool(searchAgent)', function(obj){
